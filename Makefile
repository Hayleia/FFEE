...
APP_TITLE		:= Final Fantasy Explorers Editor
APP_DESCRIPTION		:= Save editor for FFE
APP_AUTHOR		:= Hayleia
...
cia: $(TARGET)-strip.elf
	@makerom -f cia -o $(TARGET).cia -elf $(TARGET)-strip.elf -rsf resources/$(TARGET).rsf -exefslogo -target t -icon FFEE.icn
	@echo "built ... FFEE.cia"
#---------------------------------------------------------------------------------
send: $(BUILD)
	@3dslink $(TARGET).3dsx
